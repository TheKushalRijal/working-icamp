              ...
              {selectedProfile && (
                <>
                  ...
                  <Text style={styles.profileStatus}>
                    Status: {selectedProfile.status === 'confirmed' ? 'Confirmed Scammer' : 
                            selectedProfile.status === 'review' ? 'Under Review' : 'Low Reports'}
                  </Text>
                  ...
                  <View style={styles.profileDetails}>
                    ...
                    <Text style={styles.detailTitle}>Last Reported</Text>
                    <Text style={styles.detailText}>{selectedProfile.lastReported}</Text>
                  </View>
